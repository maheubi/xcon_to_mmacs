...
//	2201/?	Button  2,  Button :                [0x012201]       (0||1)
//	2201/22	Button  3,  Button X:               [0x01220116]       (0||1)
//	2201/23	Button  4,  Button Y:               [0x01220117]       (0||1)
...
int main(int argc, char **argv)
{
    ...
    std::string mycontroller_ip = "169.254.73.8";
